# Generated by Django 3.0.4 on 2020-08-25 16:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.CharField(max_length=60, verbose_name='add tags - separated by comma')),
                ('is_active', models.BooleanField(default=True)),
                ('cat_image', models.ImageField(blank=True, upload_to='product/category-cover', verbose_name='add Category Cover here')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=60)),
                ('image', models.ImageField(blank=True, default='default.png', help_text='add product image', upload_to='product/img/%Y/%m/%d')),
                ('slug', models.SlugField(max_length=60)),
                ...
                ('tag', models.ForeignKey(help_text='add tags - separated by comma', max_length=60, null=True, on_delete=django.db.models.deletion.CASCADE, to='product.Tag')),
            ],
            options={
